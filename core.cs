...
namespace P4CSAssessment.Core
{
    ...
    */
    ...
    ------------------------------------ Brief sample data testing:
    1. Brief sample data - Dishwasher:
    Input: Appliance name: "Dishwasher", Power rating: '1.8', Hours used per day: '10'
    Expected Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
    Actual Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
        The daily energy usage for your dishwasher is: 18 kWh
        Its monthly energy usage is: 540 kWh
        Its yearly energy usage is: 6570 kWh
    Result: Pass

    2. Brief sample data - Television:
    Input: Appliance name: "Television", Power rating: '1.4', Hours used per day: '14'
    Expected Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
    Actual Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
        The daily energy usage for your television is:
        19.6 kWh
        Its monthly energy usage is: 588.0 kWh
        Its yearly energy usage is: 7,154.0 kWh
    Result: Pass

    3. Brief sample data - Freezer:
    Input: Appliance name: "Freezer", Power rating: '1.5', Hours used per day: '20'
    Expected Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
    Actual Output: Displays daily, monthly, and yearly energy usage for the appliance correctly.
        The daily energy usage for your freezer is:
        30.0 kWh
        Its monthly energy usage is: 900.0 kWh
        Its yearly energy usage is: 10,950.0 kWh
    Result: Pass
    ------------------------------------ All and other testing data
    ...
    */
    public class EnergyCalculator
    {
        ...
        private Appliance GetApplianceData()
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Exiting the Energy Calculator.");
                    return null; // Exit the calculator
                }
                ...
                {
                    // User chose to go back to the category selection
                    Console.WriteLine("Returning to category selection...");
                    continue; // Restart the loop and re-prompt for category selection
                }

                // Collect data for the selected appliance
                ...
                // Return the fully defined Appliance object
    ...
    ------------------------------------ Brief sample data testing:
    1. Brief sample data - Apple, 0.50, 20:
    Input: Apple, 0.50, 20
    Expected Output: "Product added successfully!"
    Actual Output: "Product added successfully!"
        Total number of items: 20
        Item names: Apple
        Total cost of items: £10.00
    Result: Pass

    2. Brief sample data - Bread, 2.00, 5:
    Input: Bread, 2.00, 5
    Expected Output: "Product added successfully!"
    Actual Output: "Product added successfully!"
    ...
    3. Brief sample data - Scones, .25, 10:
    Input: Scones, .25, 10
    Expected Output: "Product added successfully!"
    Actual Output: "Product added successfully!"
        Total number of items: 15
        Item names: Bread,Scones
        Total cost of items: £12.50
    Result: Pass

    4. Brief sample data - Cabbage, 1.50, 5:
    Input: Cabbage, 1.50, 5 
    Expected Output: "Product added successfully!"
    Actual Output: "Product added successfully!"
        Total number of items: 25
        Item names: Apple, Cabbage
        Total cost of items: £17.50
    Result: Pass
    ------------------------------------
    ...
    8. Boundary testing (above double data type max value (double.MaxValue)):
    Input: Quantity: '1.8E+309'
    Expected output: "Specified argument was out of the range of valid values. (Parameter 'Value must be between 0 and 1.7976931348623157E+308.')"
    Actual output: "Specified argument was out of the range of valid values. (Parameter 'Value must be between 0 and 1.7976931348623157E+308.')"
    Result: pass
    */
        ...
        */
        ...
        private void AddProduct()
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Returning to category selection...");
                    continue; // Re-prompt the category selection
                }
                ...
                break; // Exit the loop after successfully adding a product
            }
        }
    ...
    ------------------------------------ Brief sample data testing:
    1. Brief sample data - 'B':
    Input: B
    Expected Output: 00010
    Actual Output: 00010
    Result: Pass

    2. Brief sample data - 'ABC':
    Input: ABC
    Expected Output: 00001 00010 00011
    Actual Output: 00001 00010 00011
    Result: Pass

    3. Brief sample data - 'BB':
    Input: BB
    Expected Output: 00010 00010
    Actual Output: 00010 00010
    Result: Pass

    4. Brief sample data - ZYX:
    Input: ZYX
    Expected Output: 11010 11001 11000
    Actual Output: 11010 11001 11000
    Result: Pass
    ------------------------------------
    ...
    */
    ...
    public static class Utilities
    {
        ...
        public static string SelectProduct(string category, IReadOnlyDictionary<string, List<string>> productCategories)
        {
            ...
            Console.WriteLine($"Available products in {category}:");
            ...
            {
                Console.WriteLine("\n" +
                    "Enter the product name, or choose an option:\n" +
                    "1. List products in the chosen category again\n" +
                    "2. Go back to category selection");

                string input = Console.ReadLine()?.Trim();

                // Check for numeric options first (1 or 2 for switch statement)
                if (int.TryParse(input, out int choice))
                {
                    switch (choice)
                    {
                        case 1:
                            // Re-list the products for user
                            Console.WriteLine($"Available products in {category}:");
                            foreach (string product in availableProducts)
                            {
                                Console.WriteLine($"- {product}");
                ...
                {
                    // Handle non-numeric input as product names
                    if (availableProducts.Any(product => product.Equals(input, StringComparison.OrdinalIgnoreCase)))
                    {
                        return input; // Valid product name
                    }
                    else
                    {
                        Console.WriteLine("Invalid input. Please enter a valid product name or choose an option.");
                    }
                }
            }
        }
    ...
    */
    public static class ProductDataProvider
    {
        ...
        {
            { "Fruit & Vegetables", new List<string> { "Apple", "Banana", "Orange", "Carrot", "Broccoli", "Potato", "Tomato", "Onion", "Lettuce", "Cabbage" } },
        ...
        {
            { "Kitchen Appliances", new List<string> { "Kettle", "Toaster", "Microwave", "Fridge", "Oven", "Freezer", "Coffee Maker", "Slow Cooker", "Air Fryer" } },
            { "Laundry & Cleaning Appliances", new List<string> { "Washing Machine", "Dishwasher", "Dryer", "Vacuum Cleaner", "Robot Vacuum", "Steam Cleaner", "Iron" } },
            { "Entertainment & Other", new List<string> { "Heater", "Air Conditioner", "Fan", "Television", "Games Console", "Computer", "Laptop", "Dehumidifier" } }
        };
        // methods to return read-only versions of the dictionaries
